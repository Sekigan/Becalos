                ...
                <table>
                    <thead>
                        ...
                        if ($resultado) {
                            ...
                            echo 
                                '<tr>
                                    <td><input type="hidden" ><li>';echo $nombre;echo ' </li></td>
                                
                                    <td><a href="aspirante-convocatoria.php"><button name="id" value="';echo $id;echo  '" >Registrar <label class="lnr lnr-chevron-right"></label></button></a></td>
                                </tr>';
