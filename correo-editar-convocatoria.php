...
/* identificar el usuario que inicio sesion*/
    ...
    $bodyC = "La convocatoria " . $nombreConvocatoria . "ha sido actualizada" . 
    "<br>Publicado por: " . $nombreA . " " . $apellidoPA . " " . $apellidoMA . 
    "<br>Departamento: " . $depto . 
    "<br>Correo: " . $mailAdmin . "<br>Teléfono: " . $telefonoAdmin . "<br>" . 
    "<br>Si desea ver cuales fueron los cambios y mas convocatorias disponibles " . 
    "<html> <body> <a href='" . $url . "' target='_blank'>haga clic en este enlace.</a> </body> </html> ";
    
    $asunto = "Cambios en la convocatoria " .  $nombreConvocatoria ;
